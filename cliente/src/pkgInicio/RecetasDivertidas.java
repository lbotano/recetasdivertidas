...
import pkgBusquedaIngredientes.BusquedaIngredientesLayout;
...
public class RecetasDivertidas extends Stage{
    ...
    private VBox sidePane(){
        ...
        for (int i = 0; i < btnI; i++) {
            ...
            switch (i) {
                case 0 ->{
                    img[i] = new Image(getClass().getResourceAsStream("/res/inicio.png"));
                    btn[i].setOnAction(e -> cambiarPestania(pestanias.INICIO));
                }

                case 1 ->{
                    img[i] = new Image(getClass().getResourceAsStream("/res/busqueda_ingrediente.png"));
                    btn[i].setOnAction(e -> cambiarPestania(pestanias.BUSQUEDAINGREDIENTES) );
                }
                case 2 ->{
                    img[i] = new Image(getClass().getResourceAsStream("/res/busqueda_texto.png"));
                    btn[i].setOnAction(e -> cambiarPestania(pestanias.BUSQUEDATEXTO));
                }
                case 3 ->{
                    img[i] = new Image(getClass().getResourceAsStream("/res/images.jpg"));
